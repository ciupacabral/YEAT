...
const Footer = () => {
  return (
    <div className="text-center bg-movuliu pt-5 pb-5">
      ...
      <span className="block text-sm text-center text-gray-300">
        Copyright 2024-2025 Yeat. All Rights Reserved.
      </span>
      ...
      <ul className="flex justify-center mt-5 space-x-5">
        ...
        <li>
          <a href="https://github.com/ciupacabral/YEAT" className="text-gray-300 hover:text-gray-900">
            <svg
              className="w-5 h-5"
              fill="currentColor"
              viewBox="0 0 24 24"
